...
/*   Updated: 2016/11/11 20:44:07 by daugier          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_right(t_struct *data)
{
	...
	if (MAP[(int)(POS_X + PLANEX * SPEED + x)][(int)POS_Y] < '2' ||
			MAP[(int)(POS_X + PLANEX * SPEED + x)][(int)POS_Y] > '5')
		POS_X += PLANEX * SPEED;
	if (MAP[(int)POS_X][(int)(POS_Y + PLANEY * SPEED + y)] < '2' ||
			MAP[(int)POS_X][(int)(POS_Y + PLANEY * SPEED + y)] > '5')
		POS_Y += PLANEY * SPEED;
}
