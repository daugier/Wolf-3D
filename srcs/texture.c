...
/*   Updated: 2016/10/25 23:14:11 by daugier          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	WALL[3] = mlx_xpm_file_to_image(MLX, "Texture/exte.xpm", &TEXT_WIDTH[3],
			&TEXT_HEIGHT[3]);
	WALL_DATA[3] = mlx_get_data_addr(WALL[3], &TEXT_BPP[3], &TEXT_SIZE_LINE[3],
			&ENDIAN);
	WALL[4] = mlx_xpm_file_to_image(MLX, "Texture/exte.xpm", &TEXT_WIDTH[4],
			&TEXT_HEIGHT[4]);
	WALL_DATA[4] = mlx_get_data_addr(WALL[4], &TEXT_BPP[4], &TEXT_SIZE_LINE[4],
			&ENDIAN);
	WALL[5] = mlx_xpm_file_to_image(MLX, "Texture/gg.xpm", &TEXT_WIDTH[5],
			&TEXT_HEIGHT[5]);
...
{
	WALL[0] = mlx_xpm_file_to_image(MLX, "Texture/floor3.xpm", &TEXT_WIDTH[0],
			&TEXT_HEIGHT[0]);
	WALL_DATA[0] = mlx_get_data_addr(WALL[0], &TEXT_BPP[0], &TEXT_SIZE_LINE[0],
			&ENDIAN);
	WALL[1] = mlx_xpm_file_to_image(MLX, "Texture/gg.xpm", &TEXT_WIDTH[1],
			&TEXT_HEIGHT[1]);
...
{
	WALL[8] = mlx_xpm_file_to_image(MLX, "Texture/ciel3.xpm", &TEXT_WIDTH[8],
			&TEXT_HEIGHT[8]);
	WALL_DATA[8] = mlx_get_data_addr(WALL[8], &TEXT_BPP[8], &TEXT_SIZE_LINE[8],
			&ENDIAN);
	WALL[9] = mlx_xpm_file_to_image(MLX, "Texture/lune.xpm", &TEXT_WIDTH[9],
			&TEXT_HEIGHT[9]);
